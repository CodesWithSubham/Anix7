...
export default function NotFound() {
  return (
    <>
      <div className="flex flex-col mt-5 items-center justify-center gap-8">
        ...
        <svg
          ...
          version="1.1"
          viewBox="0 0 100 100"
          className=" drop-shadow-lg dark:drop-shadow-[0_35px_35px_rgba(0,0,200,0.25)] w-3/5 max-w-[50vh]"
        >
